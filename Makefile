...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Thu Dec 11 18:14:55 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.hh netsocket.hh peermanager.hh peer.hh filemanager.hh fileconnection.hh shamir.hh secretmanager.hh .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.cc netsocket.cc peermanager.cc peer.cc filemanager.cc fileconnection.cc shamir.cc secretmanager.cc .tmp/peerster1.0.0/ && (cd `dirname .tmp/peerster1.0.0` && $(TAR) peerster1.0.0.tar peerster1.0.0 && $(COMPRESS) peerster1.0.0.tar) && $(MOVE) `dirname .tmp/peerster1.0.0`/peerster1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/peerster1.0.0
...
compiler_moc_header_make_all: moc_main.cpp moc_netsocket.cpp moc_peermanager.cpp moc_peer.cpp moc_filemanager.cpp moc_fileconnection.cpp moc_shamir.cpp moc_secretmanager.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_main.cpp moc_netsocket.cpp moc_peermanager.cpp moc_peer.cpp moc_filemanager.cpp moc_fileconnection.cpp moc_shamir.cpp moc_secretmanager.cpp
...
secretmanager.o: secretmanager.cc 
