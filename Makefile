...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Dec 16 02:02:16 2014
...
SOURCES       = main.cc \
		...
		fileconnection.cc \
		shamir_charles.cc \
		secretmanager_charles.cc \
		dht.cc \
		dht_kayo.cc \
		dht_daniel.cc moc_main.cpp \
		moc_netsocket.cpp \
		moc_peermanager.cpp \
		moc_peer.cpp \
		moc_filemanager.cpp \
		moc_fileconnection.cpp \
		moc_shamir_charles.cpp \
		moc_secretmanager_charles.cpp \
		moc_dht.cpp
OBJECTS       = main.o \
		netsocket.o \
		netsocket_kayo.o \
		...
		moc_shamir_charles.o \
		moc_secretmanager_charles.o \
		moc_dht.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.hh netsocket.hh peermanager.hh peer.hh filemanager.hh fileconnection.hh shamir_charles.hh secretmanager_charles.hh dht.hh .tmp/peerster1.0.0/ && $(COPY_FILE) --parents main.cc netsocket.cc netsocket_kayo.cc netsocket_charles.cc netsocket_daniel.cc peermanager.cc peer.cc filemanager.cc fileconnection.cc shamir_charles.cc secretmanager_charles.cc dht.cc dht_kayo.cc dht_daniel.cc .tmp/peerster1.0.0/ && (cd `dirname .tmp/peerster1.0.0` && $(TAR) peerster1.0.0.tar peerster1.0.0 && $(COMPRESS) peerster1.0.0.tar) && $(MOVE) `dirname .tmp/peerster1.0.0`/peerster1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/peerster1.0.0
...
compiler_moc_header_make_all: moc_main.cpp moc_netsocket.cpp moc_peermanager.cpp moc_peer.cpp moc_filemanager.cpp moc_fileconnection.cpp moc_shamir_charles.cpp moc_secretmanager_charles.cpp moc_dht.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_main.cpp moc_netsocket.cpp moc_peermanager.cpp moc_peer.cpp moc_filemanager.cpp moc_fileconnection.cpp moc_shamir_charles.cpp moc_secretmanager_charles.cpp moc_dht.cpp
...
moc_shamir_charles.cpp: shamir_charles.hh
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) shamir_charles.hh -o moc_shamir_charles.cpp

moc_secretmanager_charles.cpp: secretmanager_charles.hh
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) secretmanager_charles.hh -o moc_secretmanager_charles.cpp
...
netsocket_kayo.o: netsocket_kayo.cc netsocket.hh \
		peer.hh \
		peermanager.hh \
		filemanager.hh \
		fileconnection.hh \
		secretmanager_charles.hh \
		dht.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o netsocket_kayo.o netsocket_kayo.cc

netsocket_charles.o: netsocket_charles.cc netsocket.hh \
		peer.hh \
		peermanager.hh \
		filemanager.hh \
		fileconnection.hh \
		...
		dht.hh \
		shamir_charles.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o netsocket_charles.o netsocket_charles.cc

netsocket_daniel.o: netsocket_daniel.cc netsocket.hh \
		peer.hh \
		peermanager.hh \
		filemanager.hh \
		fileconnection.hh \
		secretmanager_charles.hh \
		dht.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o netsocket_daniel.o netsocket_daniel.cc
...
shamir_charles.o: shamir_charles.cc shamir_charles.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o shamir_charles.o shamir_charles.cc

secretmanager_charles.o: secretmanager_charles.cc secretmanager_charles.hh \
		shamir_charles.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o secretmanager_charles.o secretmanager_charles.cc

dht.o: dht.cc dht.hh \
		peer.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dht.o dht.cc

dht_kayo.o: dht_kayo.cc dht.hh \
		peer.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dht_kayo.o dht_kayo.cc

dht_daniel.o: dht_daniel.cc dht.hh \
		peer.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dht_daniel.o dht_daniel.cc
...
moc_shamir_charles.o: moc_shamir_charles.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_shamir_charles.o moc_shamir_charles.cpp

moc_secretmanager_charles.o: moc_secretmanager_charles.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_secretmanager_charles.o moc_secretmanager_charles.cpp
